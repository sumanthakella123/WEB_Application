...
// index.js
async function fetchFromOpenAI(userInput, conversationHistory) {
...
async function generateResponse(userInput, conversationHistory) {
    try {
        const response = await fetchFromOpenAI(userInput, conversationHistory);

        if (!response.data.choices.length) {
            throw new Error('No response generated by GPT-4');
        }
