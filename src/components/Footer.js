      ...
      <div className={"container-fluid  "+css['footer-box']}>
        <div className="row p-3 border-bottom">
          ...
          <div className={"col-3 p-3 "+css['footer-col']}>
            ...
            <p>
              Our temple is dedicated to promoting spiritual growth and community service. We offer a peaceful and
              sacred space for worship, meditation, and connecting with the divine.
            </p>
          </div>
          ...
          <div className={"col-3 p-3  "+css['footer-col']}>
            ...
            <ul className="list-unstyled">
              <li>
                <FontAwesomeIcon icon={faMapMarkerAlt} /> 123 Temple Street, City, Country
              </li>
              <li>
        ...
        <div className={"col-3  p-3  "+css['footer-col']}>
            <p className="mb-0">&copy; {new Date().getFullYear()} Temple Name. All rights reserved.</p>
            </div>
        </div>
